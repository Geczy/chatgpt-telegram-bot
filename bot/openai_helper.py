...
GPT_4_MODELS = ("gpt-4", "gpt-4-0314", "gpt-4-0613", "gpt-4-turbo-preview", "pplx-7b-chat", "sonar-small-online")
GPT_4_32K_MODELS = ("gpt-4-32k", "gpt-4-32k-0314", "gpt-4-32k-0613", "llama-3-sonar-small-32k-online")
    ...
    async def __handle_function_call(
        ...
        if is_direct_result(function_response):
            self.__add_function_call_to_history(
                ...
                content=json.dumps(
                    {"result": "Done, the content has been sent" "to the user."}
                ),
            )
